    ...
    jQuery.fn.extend({
        ...
        "M_select":function(options){
            ...
            for(i=0;i<ojc_arr.length;i++){
                ...
                $ser_object.parent().parent().append('<section class="sel-box" style="width: 90%;margin-left: 20px;margin-right: 20px;font-size: 12px;background-color: #ffffff;">'
													+'<div class="sel-title-box" style="margin-bottom: 5px;margin-top: 5px;"><span class="sel-title" ></span><span class="sel-sign"></span></div><section class="sel-float-box" ></section></section>');
                var w=($ser_object.parent().parent().width())*0.9;
                $ser_object.parent().parent().find(".sel-float-box").css("width",w);
				// $ser_object.parent().parent().find(".sel-float-box").css("height",40px);
				// $ser_object.parent().parent().find(".sel-float-box").css("margin-left",20px);
				// $ser_object.parent().parent().find(".sel-float-box").css("margin-right",20px);
				// $ser_object.parent().parent().find(".sel-float-box").css("margin-top",20px);
				// $ser_object.parent().parent().find(".sel-float-box").css("font-size",20px);
				// 
